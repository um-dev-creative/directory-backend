...
import com.umdev.commons.util.HttpStatusUtil;
import com.umdev.directory.api.v1.service.BusinessService;
...
public interface BusinessApi {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = HttpStatusUtil.INTERNAL_SERVER_ERROR_STR, description = DirectoryAppConstants.INTERNAL_SERVER_ERROR_MESSAGE, content = @Content)
    })
