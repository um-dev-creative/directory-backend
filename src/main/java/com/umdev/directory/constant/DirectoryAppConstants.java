...
public final class DirectoryAppConstants {
    public static final String ENTITY_PACKAGE = "com.umdev.directory.jpa.entity";
    public static final String REPOSITORY_PACKAGE = "com.umdev.directory.jpa.repository";
