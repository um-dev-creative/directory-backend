...
import com.umdev.directory.api.v1.to.BusinessTO;
...
public interface BusinessMapper {
    ...
    @Mapping(target = "email", expression = "java(getValueByName(com.umdev.directory.constant.ContactTypeKey.EML, businessEntity))")
    @Mapping(target = "website", expression = "java(getValueByName(com.umdev.directory.constant.ContactTypeKey.WBH, businessEntity))")
    @Mapping(target = "customerServiceEmail", expression = "java(getValueByName(com.umdev.directory.constant.ContactTypeKey.SCE, businessEntity))")
    @Mapping(target = "orderManagementEmail", expression = "java(getValueByName(com.umdev.directory.constant.ContactTypeKey.MEC, businessEntity))")
