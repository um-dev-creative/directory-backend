...
class UserServiceImplExtendedTest {
    ...
    void create_nullRequest() {
        ...
        assertTrue(result.getHeaders().containsKey("message-error"));
    ...
    void update_success() {
        ...
        when(putUserMapper.toBackbone(any(UUID.class), any())).thenReturn(mock(com.prx.directory.client.backbone.to.BackboneUserUpdateRequest.class));
